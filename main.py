    ...
    while True:
        ...
        if inp == 9:
            ...
            if inp9 == 1:
                ...
                position_list = np.loadtxt('./nbh_folder/nbh_file_coords400.csv', delimiter='$').astype('float64')  #nbh_file_coords30.csv # ./Data/coordinates00.csv
                genotype_matrix = np.loadtxt('./nbh_folder/nbh_file_genotypes400.csv', delimiter='$').astype('float64')
