...
class MultiNbh(MultiRun):
    ...
    def analyze_data_set(self, data_set_nr, random_ind_nr=None, method=2, fit_t0=0):
        ...
        self.fit_IBD(start_params, data_set_nr, method=method,
                    res_folder=None, position_list=[], genotype_mat=[], random_ind_nr=random_ind_nr)
...
class MultiBarrierPosition(MultiRun):
    ...
    def analyze_data_set(self, data_set_nr, method=2, nr_x_bins=50, nr_y_bins=10, nr_bts=20,
        ...
        # Save the Parameters used for Inference
        # description = ["Nr x-Bins", "Nr y-Bins", "Min Ind Nr", "Min Dist", "Max Dist"] + ["Start Params", ] * len(start_params)
        inf_params = [nr_x_bins, nr_y_bins, min_ind_nr, min_dist, max_dist] + list(start_params)
        self.save_mat(inf_params, filename="inf_params.csv", method=2, res_folder=res_folder)
