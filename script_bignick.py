...
MultiRun = fac_method("multi_hz_pos", "./multi_barrier_hz_ALL/all_v2.0/", multi_processing = mp)  # Date Set for Antirrhinum Analysis All
...
MultiRun.analyze_data_set(data_set_nr, method=2, res_folder="result/", barrier_pos=[], use_ind_nr=0,
                          min_dist=1.0, max_dist=50.0, nr_bts=10, nr_x_bins=100, nr_y_bins=20, min_ind_nr=5, start_params=[150.0, 0.0001, 0.05])
