...
MultiRun = fac_method("multi_hz_pos", "./multi_barrier_hz_ALL14/max2000v2/", multi_processing=mp)  # Whole DataSet for Antirrhinum Analysis(Chromosome 0)
...
MultiRun.analyze_data_set(data_set_nr, method=2, res_folder="result/", barrier_pos=np.linspace(-30, 30, 25), use_ind_nr=0,
                          min_dist=1.0, max_dist=40.0, nr_bts=10, nr_x_bins=50, nr_y_bins=10, min_ind_nr=5, start_params=[150.0, 0.0001, 0.05])
